      ...
      (u = new Bt({})),
      {
        c() {
          (n = w("p")),
            (s = w("p")),
            (n.innerHTML =
              'Have questions/run into bugs? Tweet/DM me @LaughAndPeace11 on Twitter!<br><br>Also, for a new Heardle every day, check out the original <a href="https://sonic-heardle.glitch.me/" title="">Sonic Heardle</a>!'),
            (r = x()),
            (s = w("p")),
            (i = x()),
            (o = w("div")),
