var app = (function () {
  ...
  var musicNameList = [
    ...
    {
      id: 143,
      name: "Cityscape: The Ones Engraved in Legends [Adventurer Guild] - Etrian Odyssey 2 Untold: The Fafnir Knight",
    },
    {
      id: 144,
    ...
    {
      id: 178,
      name: "Engrave Thy Name [Adventurer's Guild] - Etrian Mystery Dungeon",
    },
    {
      id: 179,
    ...
    {
      id: 211,
      name: "Cityscape: Names That will be Spoken of for Generations [Adventurer Guild] - Etrian Odyssey 5: Beyond the Myth",
    },
    {
      id: 212,
    ...
    {
      id: 255,
      name: "Cityscape: Etch Thy Name among the Stars [Adventurer Guild] - Etrian Odyssey Nexus",
    },
    {
      id: 256,
      ...
      (u = new Bt({})),
      {
        c() {
          (n = w("p")),
            (s = w("p")),
            (n.innerHTML =
              'Have questions/run into bugs? DM Beignet0 on Reddit, beignetSan on Twitch or beignet1139 on Discord!<br><br>You can also play <a href="https://etrian-heardle.glitch.me/" title="Etrian Odyssey Heardle">Etrian Odyssey Heardle</a> daily.'),
            (r = x()),
            (s = w("p")),
            (i = x()),
            (o = w("div")),
